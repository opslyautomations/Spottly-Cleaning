...
export const metadata: Metadata = {
  ...
  description: "Salt air, sand, and marine-layer humidity do real damage to coastal surfaces over time. What Westside and South Bay homeowners actually deal with and need.",
