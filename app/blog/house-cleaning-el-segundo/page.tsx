...
export const metadata: Metadata = {
  ...
  description: "El Segundo is a tight-knit South Bay community with a strong homeowner base near LAX. What professional house cleaning looks like in this small-town city.",
