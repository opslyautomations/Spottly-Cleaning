...
export const metadata: Metadata = {
  ...
  description: "Renting in LA comes with specific cleaning considerations — from lease requirements to deposit protection and move-out prep. What LA renters need to know.",
