...
export const metadata: Metadata = {
  ...
  description: "They're not interchangeable. A standard clean maintains; a deep clean removes history. Here's what each covers and when to choose which one for your LA home.",
