...
export const metadata: Metadata = {
  ...
  description: 'House cleaning in Westchester near LAX — single-family homes and flight-crew schedules in a quiet LA neighborhood. Recurring and move-out cleaning by Spottly.',
