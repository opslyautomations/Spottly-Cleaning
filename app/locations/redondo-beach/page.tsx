...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://spottly.com/og/redondo-beach.png', width: 1200, height: 630, alt: 'House Cleaning in Redondo Beach' }],
  },
  twitter: { card: 'summary_large_image', title: 'House Cleaning in Redondo Beach, CA | Spottly', description: 'House cleaning in Redondo Beach—from Riviera Village to King Harbor.', images: ['https://spottly.com/og/redondo-beach.png'] },
}
